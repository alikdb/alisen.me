...
import {dasherize} from "@/libs/utils";
    ...
    return {
        ...
        renderNode: {
            ...
            [BLOCKS.UL_LIST]: (_, children) => <ul
                className="mb-4 flex list-disc flex-col gap-0.5 pl-6">{children}</ul>,
            ...
            [BLOCKS.QUOTE]: (_, children) => (
                <blockquote
                    className="mb-4 rounded-r-lg border-l-2 border-gray-200 px-4 font-medium">{children}</blockquote>
            ),
